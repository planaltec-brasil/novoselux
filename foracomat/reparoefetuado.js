...
class Reparoefetuado {
  ...
  async listagem(page, browser, arr = [], i = 0) {
    try {
      ...
      if (detalhamentoValue.includes("Reparo concluido, aguardando confirmação")) {
        ...
        await page.keyboard.type(
          `Reparo concluido, aguardando confirmação do consumidor sobre funcionamento do produto.`
        );
        await page.waitForTimeout(2000);
        await rep.updateGatilhoSinistros(arr[i].id);
        //Salvar
