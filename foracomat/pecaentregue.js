...
class PecaEntregue {
  ...
  async listagem(page, browser, arr = [], i = 0) {
    try {
      ...
      if (detalhamentoValue.includes("Peça entregue, reparo será agendado")) {
        ...
        const option = await page.$("ul.dropdown-list li:nth-child(33)");
        await option.click();
        ...
        await page.keyboard.type(
          `Peça entregue, reparo será agendado ${AGFormatado}`
        );
        await page.waitForTimeout(2000);
        await rep.updateGatilhoSinistros(arr[i].id);
        //Salvar
