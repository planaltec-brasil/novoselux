...
class NaoEnviado {
  ...
  async listagem(page, browser, arr = [], i = 0) {
    try {
      ...
      if (detalhamentoValue.includes("Atendimento NaoEnviado para")) {
        ...
        await page.keyboard.type(
          `${dataFormatada} - Contato realizado, aguardando retorno com a documentação ${AGFormatado}.`
        );
        await page.waitForTimeout(2000);
        await rep.updateGatilhoSinistros(arr[i].id);
        //Salvar
