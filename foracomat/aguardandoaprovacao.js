...
class AguardandoAprov {
  ...
  async listagem(page, browser, arr = [], i = 0) {
    try {
      ...
      if (detalhamentoValue.includes("Aguardando analise SAC sobre negociação com o consumidor")) {
        ...
        await page.keyboard.type(
          `Aguardando analise SAC sobre negociação com o consumidor.`
        );
        await page.waitForTimeout(2000);
        await rep.updateGatilhoSinistros(arr[i].id);
        //Salvar
