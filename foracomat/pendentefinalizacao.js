...
class PendenteFinalizacao {
  ...
  async listagem(page, browser, arr = [], i = 0) {
    try {
      ...
      if (detalhamentoValue.includes("Reparo agendado para o dia")) {
        ...
        await page.keyboard.type(
          `Reparo agendado para o dia ${AGFormatado}.`
        );
        await page.waitForTimeout(2000);
        await rep.updateGatilhoSinistros(arr[i].id);
        //Salvar
...
const rep = new PendenteFinalizacao();
rep.logando();
