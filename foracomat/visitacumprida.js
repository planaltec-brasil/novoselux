...
class VisitaCumprida {
  ...
  async listagem(page, browser, arr = [], i = 0) {
    try {
      ...
      if (detalhamentoValue.includes("Realizado análise técnica, assim que recebermos")) {
        ...
        await page.keyboard.type(
          `Realizado análise técnica, assim que recebermos a análise iremos lançar, previsão ${AGFormatado}.`
        );
        await page.waitForTimeout(2000);
        await rep.updateGatilhoSinistros(arr[i].id);
        //Salvar
