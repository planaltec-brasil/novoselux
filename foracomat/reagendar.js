...
class reagendar {
  ...
  async listagem(page, browser, arr = [], i = 0) {
    try {
      ...
      if (detalhamentoValue.includes("Atendimento não realizado, aguardando nova data para agendamento.")) {
        ...
        await page.keyboard.type(
          `Atendimento não realizado, aguardando nova data para agendamento.`
        );
        await page.waitForTimeout(2000);
        await rep.updateGatilhoSinistros(arr[i].id);
        //Salvar
