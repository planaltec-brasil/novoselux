    ...
    try {
      ...
      if (
        detalhamentoValue.includes(
          "O posto designado não poderá atender, estamos agendando com novo prestador. Previsão"
        )
      ) {
        ...
        await page.keyboard.type(
          `${dataFormatada} - O posto designado não poderá atender, estamos agendando com novo prestador. Previsão ${AGFormatado}.`
        );
        await page.waitForTimeout(5000);
