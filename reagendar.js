    ...
    try {
      ...
      if (
        detalhamentoValue.includes(
          "O atendimento não foi realizado, iremos reagendar o atendimento. Previsão"
        )
      ) {
        ...
        await page.keyboard.type(
          `${dataFormatada} - O atendimento não foi realizado, iremos reagendar o atendimento. Previsão ${AGFormatado}`
        );
        await page.waitForTimeout(5000);
